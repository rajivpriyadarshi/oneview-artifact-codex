  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-6 scrollbar-thin relative">
        ...
        {/* 7. Northern Trust / Signal Alert (11:04 AM) — VISIBLE FOR Step >= 8 */}
        {currentStep >= 8 && (
          <div className="relative flex items-start gap-3.5 z-10 group animate-in fade-in duration-200">
            <div className="w-7 h-7 rounded-full bg-[#faeae5] border border-[#f2cfc7] text-[#b53a22] flex items-center justify-center shrink-0 mt-0.5">
              <AlertCircle className="w-3.5 h-3.5" />
            </div>
            <div className="min-w-0 flex-1 space-y-1.5">
              <div className="flex items-center justify-between">
                <span className="text-[13px] font-sans font-bold text-[#b53a22]">Northern Trust Alert</span>
                <span className="text-[11px] font-sans text-[#71717a]">11:04 AM</span>
              </div>
              <p className="text-[12.5px] font-sans text-[#7a3224] leading-relaxed">
                Confirmed: $420,000 NVDA RSU grant vested into Account *4920 today. Projected technology exposure rebounds to 51.0%.
              </p>
              ...
              <div
                ...
                className={`p-3 rounded-xl border flex items-center justify-between transition-all cursor-pointer ${
                  currentStep === 8
                    ? "bg-[#faeae5] border-[#f2cfc7] shadow-xs ring-1 ring-[#b53a22]/20"
                    : "bg-white border-[#e5e1d7] hover:border-[#d2cdbf]"
                }`}
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <div className="w-8 h-8 rounded-lg bg-[#fce8e4] border border-[#f4c8be] flex items-center justify-center text-[#b53a22] shrink-0">
                ...
                <ArrowRight className="w-4 h-4 text-[#b53a22] shrink-0 ml-2" />
              </div>
            </div>
          </div>
        )}

        {/* 8. Zinc - Updated directions (11:10 AM) — VISIBLE FOR Step >= 9 */}
        {currentStep >= 9 && (
          <div className="relative flex items-start gap-3.5 z-10 group animate-in fade-in duration-200">
            <div className="w-7 h-7 rounded-full bg-[#f4ece1] border border-[#e8dcc9] text-[#8b6534] flex items-center justify-center shrink-0 shadow-2xs mt-0.5">
              <Sparkles className="w-3.5 h-3.5" />
            ...
            <div className="min-w-0 flex-1 space-y-1.5">
              <div className="flex items-center justify-between">
                <span className="text-[13px] font-sans font-bold text-[#18181b]">Zinc</span>
                <span className="text-[11px] font-sans text-[#71717a]">11:10 AM</span>
              </div>
              <div className="text-[13px] font-sans font-semibold text-[#18181b]">
                Updated directions ready
              </div>
              <p className="text-[12.5px] font-sans text-[#52525b] leading-relaxed">
                Evaluated 3 revised paths to incorporate the new $420k shares.
              </p>
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <div className="w-8 h-8 rounded-lg bg-[#f7f3ea] border border-[#ebdcc2] text-[#8b6534] flex items-center justify-center shrink-0">
                    <Scale className="w-4 h-4" />
                  </div>
                  <div className="min-w-0">
                    <div className="text-[12.5px] font-sans font-semibold text-[#18181b] truncate">
                      Updated Transition Direction
                    </div>
                    <div className="text-[11px] font-sans text-[#71717a]">
                      3 direction options · 5 min
                    </div>
                  </div>
                </div>
                <ArrowRight className="w-4 h-4 text-[#8b6534] shrink-0 ml-2" />
              </div>
            </div>
          </div>
        )}

        {/* 9. Sarah - Adopt Option 1 (11:18 AM) — VISIBLE FOR Step >= 10 */}
        {currentStep >= 10 && (
          <div className="relative flex items-start gap-3.5 z-10 group animate-in fade-in duration-200">
            <div className="w-7 h-7 rounded-full bg-[#828c94] text-white flex items-center justify-center font-sans text-xs font-bold shrink-0 shadow-2xs mt-0.5">
              S
            ...
            <div className="min-w-0 flex-1 space-y-1">
              <div className="flex items-center justify-between">
                <span className="text-[13px] font-sans font-bold text-[#18181b]">Sarah</span>
                <span className="text-[11px] font-sans text-[#71717a]">11:18 AM</span>
              </div>
              <p className="text-[12.5px] font-sans text-[#18181b] leading-relaxed">
                Adopt Option 1 (Extend to 15 months, absorb vest). Prepare client note.
              </p>
            </div>
          </div>
        )}
